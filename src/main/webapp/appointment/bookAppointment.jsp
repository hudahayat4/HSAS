...
<style type="text/css"> <%@ include file="../css/bookAppointment.css"%> </style>
</head>
...
<form method="post" action="AppointmentController">
    ...
    <input type="hidden" id="customerID" name="customerID"
           value="<%= session.getAttribute("cusID") %>">
            ...
            <div class="col-md-6 col-lg-5 d-flex">
                <div class="card h-100 w-100">
                    <div class="calendar-toolbar">
                        <button type="button" class="prev month-btn"><i class="bi bi-chevron-left"></i></button>
                        <div class="current-month"></div>
                        <button type="button" class="next month-btn"><i class="bi bi-chevron-right"></i></button>
                    </div>

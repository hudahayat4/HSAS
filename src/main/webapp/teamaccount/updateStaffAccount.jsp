        ...
        <form action="StaffController?action=updateProfile" method="POST">
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" value="${staff.name}" readonly class="locked-field">
                </div>
                
                <div class="form-group">
                    <label>Phone</label>
                    <input type="text" name="PhoneNo" value="${staff.phoneNo}" class="editable-field" required>
                </div>

                <div class="form-group">
                    <label>Email Address</label>
                    <input type="email" name="email" value="${staff.email}" class="editable-field" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="${staff.DOB}" readonly class="locked-field">
                </div>
            
                <div class="form-group">
                    <label>IC Number</label>
                    <input type="text" value="${staff.NRIC}" readonly class="locked-field">
                </div>
            </div>

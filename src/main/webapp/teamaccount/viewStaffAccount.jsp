...
<div id="passwordModal" class="custom-modal">
    <div class="modal-box">
        ...
        <form id="changePasswordForm" action="StaffController?action=changePassword" method="POST">
            
            <div class="mb-3">
                <label class="form-label fw-bold">Current Password</label>
                <div class="password-container">
                    <input type="password" name="currentPassword" class="form-control" id="currPass" required>
                    <i class="fas fa-eye toggle-password" onclick="toggleVisibility('currPass', this)"></i>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <small class="text-muted">Must be at least 8 characters, with 1 uppercase letter and 1 number.</small>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="password-container">
                    ...
                    <i class="fas fa-eye toggle-password" onclick="toggleVisibility('confPass', this)"></i>
                </div>
            </div>

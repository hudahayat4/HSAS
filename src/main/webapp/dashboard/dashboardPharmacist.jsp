...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/dashboardPharmacist.css">
...
<body>
            ...
            <div class="main-content-area">
                ...
                <div class="banner-box animate-card delay-1">
                    <div class="banner-content">
                        ...
                        <p>Your dedication to health makes a difference. Check today's schedule and lead the journey to wellness.</p>
                    </div>
                        ...
                        %>
                            <div class="free-state">
                                <div class="free-state-content">
                                    ...
                                    <p>No appointments scheduled. Perhaps it's time for a lovely cup of tea?</p>
                                </div>
                            </div>
                        <% } else { %>
            ...
            <div class="info-box-container">
                ...
                <div class="styled-card quote-card animate-card delay-3">
                    <div class="card-body">
                        ...
                        <p id="daily-quote">"The art of healing comes from nature, not from the physician."</p>
    ...
    <script>
        ...
        if (hour < 12) greetingElement.innerHTML = "Top of the morning to you! Ready for a brilliant day?";
        else if (hour < 17) greetingElement.innerHTML = "Good afternoon! Hope your day is going swimmingly.";
        else greetingElement.innerHTML = "Good evening! Wrapping up a grand day, are we?";

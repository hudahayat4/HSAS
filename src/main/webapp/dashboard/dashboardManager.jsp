...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/dashboardManager.css?v=1.1">
...
<%
    ...
    try {
        ...
        if(rsTeam.next()) totalTeams = rsTeam.getInt(1);

        // 3. Total Packages
        PreparedStatement psPkg = conn.prepareStatement("SELECT COUNT(*) FROM packages");
        ResultSet rsPkg = psPkg.executeQuery();
        if(rsPkg.next()) totalPackages = rsPkg.getInt(1);

        // 4. Total Appointments
        PreparedStatement psApt = conn.prepareStatement("SELECT COUNT(*) FROM appointments");
        ResultSet rsApt = psApt.executeQuery();
        if(rsApt.next()) totalAppointments = rsApt.getInt(1);
...
%>
    ...
    <div class="dashboard-container">
        <div class="mb-4">
            ...
            <p class="text-muted">Real-time overview powered by ConnectionManager.</p>
        </div>
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-3">
                <div class="stat-card">
                    <div class="icon-circle bg-rev"><i class="fas fa-coins"></i></div>
                    <div>
                        <small class="text-muted fw-bold">TOTAL REVENUE</small>
                        <h4 class="m-0 fw-bold">RM <%= String.format("%.2f", totalRevenue) %></h4>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="stat-card">
                    <div class="icon-circle bg-team"><i class="fas fa-users-cog"></i></div>
                    <div>
            ...
            <div class="col-md-3">
                <div class="stat-card">
                    <div class="icon-circle bg-pkg"><i class="fas fa-box"></i></div>
                    <div>
            ...
            <div class="col-md-3">
                <div class="stat-card">
                    <div class="icon-circle bg-apt"><i class="fas fa-calendar-alt"></i></div>
                    <div>
        ...
        <div class="mt-5 pt-4 border-top">
            ...
            <div class="d-flex flex-wrap gap-3">
                <a href="createTeamAccount.jsp" class="btn-custom"><i class="fas fa-user-plus"></i> Create Team Account</a>
                <a href="viewStaffDetails.jsp" class="btn-outline"><i class="fas fa-id-card"></i> View Staff Records</a>
                <a href="viewpackage.jsp" class="btn-outline"><i class="fas fa-layer-group"></i> Manage Packages</a>
            </div>
        </div>
    </div>

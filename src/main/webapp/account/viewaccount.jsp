...
<body>
        ...
        <div class="profile-container">
            <div class="profile-header">
                ...
                <div class="action-buttons">
                	<a href="${pageContext.request.contextPath}/account/CustomerController?action=edit" class="btn-edit-link">Edit</a>
    ...
    <div id="passwordModal" class="custom-modal">
        <div class="modal-box">
            ...
            <form id="changePasswordForm" action="CustomerController" method="POST">
                ...
                <div class="d-flex justify-content-end gap-2 modal-footer-custom">
				    <button type="button" class="btn modal-btn-white" onclick="toggleModal(false)">Cancel</button>
